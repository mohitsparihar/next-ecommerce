...
// This is the way to define types in Typescript
type Cart = {
    items: OrderItem[]
    itemsPrice: number
    taxPrice: number
...
// Initial value for the zutand store
...
// Creating the store in zustand using Cart type and setting its value to the initialState
...
// Creating hook for using zustand state in other components
